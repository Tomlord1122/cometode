      ...
      <div class="space-y-3">
        ...
        <div class="flex gap-2">
          <a
            ...
            class="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-orange-400/90 hover:bg-orange-500/95 text-white rounded-md text-sm font-medium transition-colors shadow-sm"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-gray-200/90 hover:bg-gray-300/95 dark:bg-gray-700/90 dark:hover:bg-gray-600/95 text-gray-700 dark:text-gray-300 rounded-md text-sm font-medium transition-colors shadow-sm"
          >
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              <path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z" />
              <path d="M5 5a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-3a1 1 0 10-2 0v3H5V7h3a1 1 0 000-2H5z" />
